...
def extract_and_process_data(zip_path):
    ...
    # Find the first CSV file inside the extracted folder
    ...
    # 🔹 Print First 5 Rows of the New Dataset for Debugging
    print("\n📌 First 5 Rows of Uploaded Dataset:")
    print(df.head())

    # 🔹 Detect the Correct Latitude & Longitude Columns
    ...
    # If lat_col is Y and another Y.1 exists, choose the correct one
    ...
    # 🔹 Convert (0,0) values to NaN instead of removing everything
    ...
    # 🔹 Print 5 sample coordinates for debugging
    print("\n📌 Sample Coordinates (After Cleaning):")
    print(df[[lat_col, lon_col]].head(5))

    # 🔹 DELETE OLD HEATMAP to ensure new one is generated
